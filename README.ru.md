...
Под Windows тот же скрипт называется `install.ps1`. Про оба, а заодно и про сами
бинарники, написано в отдельном документе:
[бинарники и установщики](docs/ru/binaries.md).
